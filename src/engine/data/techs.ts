...
export const TECHS: TechDef[] = [
  ...
  { id: 'lagerwagen', name: 'Lagerwagen', description: 'Lagerwagen baubar, plus 200 Kapazität je Ware.', cost: { item: 'bp_eisen', amount: 8 }, seconds: 60, requires: ['werkwagen'], effects: [{ kind: 'wagen', wagon: 'lager' }] },
